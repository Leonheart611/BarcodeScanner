...
class PickingDetailFragment : Fragment() {
    ...
    val args: PickingDetailFragmentArgs by navArgs()
    val pickingListHeaderValue by lazy { viewModel.pickingListRepository.getPickingListHeader(args.pickingListNo) }
